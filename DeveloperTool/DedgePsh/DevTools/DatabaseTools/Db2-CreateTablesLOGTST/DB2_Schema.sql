...
GRANT SELECT ON ALL TABLES IN SCHEMA LOGHANDLER TO GROUP DB2USERS;
GRANT CONTROL ON SCHEMA LOGHANDLER TO GROUP DB2ADMNS;
GRANT SELECT ON ALL TABLES IN SCHEMA LOGHANDLER TO GROUP DB2ADMNS;
