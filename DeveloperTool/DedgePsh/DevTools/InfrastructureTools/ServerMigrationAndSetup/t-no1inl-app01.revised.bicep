...
resource vmCustomScript 'Microsoft.Compute/virtualMachines/extensions@2022-03-01' = {
  ...
  properties: {
    ...
    protectedSettings: {
      commandToExecute: 'powershell.exe -ExecutionPolicy Bypass -Command "Set-WinSystemLocale -SystemLocale nb-NO; Set-WinUserLanguageList -LanguageList en-US, nb-NO -Force; Set-WinUserLanguageList -LanguageList nb-NO -Force; Set-Culture en-DK; Set-WinHomeLocation -GeoId 0xB1; $langList = New-WinUserLanguageList -Language nb-NO; $langList[0].InputMethodTips.Clear(); $langList[0].InputMethodTips.Add(\'0414:00000414\'); Set-WinUserLanguageList -LanguageList $langList -Force; Set-TimeZone -Id \'Central European Standard Time\'; Restart-Computer -Force"'
    }
  }
}
