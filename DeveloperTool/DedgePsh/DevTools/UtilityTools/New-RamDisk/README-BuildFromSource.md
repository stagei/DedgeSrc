...
- **Code Signing**: Automatically sign binaries with DedgeSign (Azure Trusted Signing) after build
...
- **DedgeSign module** - For code signing (automatically available in GlobalFunctions)
...
| `-SignBinaries` | `$true` | Sign compiled binaries using DedgeSign after build |
...
- **DedgeSign** (Azure Trusted Signing)
- Dedge's trusted certificate
