<#
.SYNOPSIS
    Connection and database configuration for DedgeAuth PostgreSQL operations.

.DESCRIPTION
    Returns a hashtable of connection parameters used by DedgeAuth-Backup-Database.ps1 and
    DedgeAuth-Restore-Database.ps1. Copy this file to other PostgreSQL-backed projects and
