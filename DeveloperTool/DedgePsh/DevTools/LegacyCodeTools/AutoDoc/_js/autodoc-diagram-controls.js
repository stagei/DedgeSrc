...
<body>
  <div class="toolbar">
    ...
    <div class="btn-group">
      <button class="btn" onclick="pz.zoomIn()" title="Zoom In"><i class="bi bi-zoom-in"></i></button>
      <button class="btn" onclick="pz.zoomOut()" title="Zoom Out"><i class="bi bi-zoom-out"></i></button>
      <button class="btn" onclick="pz.resetZoom(); pz.center();" title="Reset"><i class="bi bi-arrows-angle-contract"></i></button>
    </div>
    <span class="zoom-indicator" id="zoom">100%</span>
    <button class="btn" onclick="pz.fit(); pz.center();" title="Fit"><i class="bi bi-arrows-fullscreen"></i></button>
  </div>
