...
public class AuthConfiguration
{
    ...
    /// <summary>
    /// Base URL for email links (e.g., "http://localhost:8100")
    /// </summary>
    public string BaseUrl { get; set; } = string.Empty;

    /// <summary>
    /// Server base URL for IIS-hosted applications (e.g., "http://dedge-server").
    /// Used by the seeder to generate correct app routing URLs like {ServerBaseUrl}/{AppId}.
    /// When empty, falls back to localhost URLs (for local development).
    /// </summary>
...
public class SmtpConfiguration
{
    ...
    public string FromName { get; set; } = "DedgeAuth";
}
