...
public static class TokenTypes
{
    ...
    /// <summary>
    /// Short-lived auth code exchanged server-to-server for a JWT.
    /// Used instead of passing the full JWT in redirect URLs to avoid
    /// exceeding IIS maxQueryString limits.
    /// </summary>
