...
<#
.SYNOPSIS
    Builds the SqlMermaidErdTools NuGet package with bundled Python and Node.js runtimes.
...
$NodeVersion = "18.19.0"
$RuntimeDir = Join-Path $PSScriptRoot "..\src\SqlMermaidErdTools\runtimes\$($RuntimeId)"

Write-Host @"

╔══════════════════════════════════════════════════════════════╗
║                                                              ║
║           SqlMermaidErdTools Package Builder                    ║
...
$sourceScriptsDir = Join-Path $PSScriptRoot "..\src\SqlMermaidErdTools\scripts"
...
try {
    ...
    # First build
    dotnet build src\SqlMermaidErdTools\SqlMermaidErdTools.csproj -c $Configuration
