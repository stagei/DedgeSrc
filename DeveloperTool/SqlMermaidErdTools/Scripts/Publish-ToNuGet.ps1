...
<#
.SYNOPSIS
    Builds and publishes SqlMermaidErdTools NuGet package.
...
Write-Host "  SqlMermaidErdTools NuGet Package Builder & Publisher" -ForegroundColor Magenta
Write-Host "═══════════════════════════════════════════════════════" -ForegroundColor Magenta
...
if (-not $SkipTests) {
    ...
    dotnet test SqlMermaidErdTools.sln --configuration Release --verbosity minimal --nologo
