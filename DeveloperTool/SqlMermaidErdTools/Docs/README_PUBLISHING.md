...
Your **SqlMermaidErdTools** package has been successfully built and is ready to publish!

- ✅ Package built: `SqlMermaidErdTools.0.1.0.nupkg` (22 MB)
- ✅ Symbol package: `SqlMermaidErdTools.0.1.0.snupkg` (debugging symbols)
...
1. **Get API Key** (2 minutes)
   ...
   - Create new key with glob pattern `SqlMermaidErdTools*`
   - Copy the key
...
3. **Wait** (5-15 minutes)
   - Package appears on https://www.nuget.org/packages/SqlMermaidErdTools

4. **Done!** 🎉
   - Users can install: `dotnet add package SqlMermaidErdTools`
...
│   └── SqlMermaidErdTools.xml (documentation)
├── runtimes/win-x64/
...
2. **Add badges to README:**
   ...
   [![Downloads](https://img.shields.io/nuget/dt/SqlMermaidErdTools.svg)](https://www.nuget.org/packages/SqlMermaidErdTools/)
