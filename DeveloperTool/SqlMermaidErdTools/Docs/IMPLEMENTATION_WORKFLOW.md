...
SqlMermaidErdTools follows an automated, agent-driven development workflow where the Cursor agent autonomously implements the entire solution based on specifications, with minimal human intervention.
...
├─ Implementation:
│  ├─ Create src/SqlMermaidErdTools/Models/TableDefinition.cs
