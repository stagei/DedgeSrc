# Backend Components for SqlMermaidErdTools

## Overview

This document outlines existing open-source libraries and tools that can be leveraged as backend components for the SqlMermaidErdTools NuGet package. Instead of building SQL parsing and conversion from scratch, we can utilize mature, well-tested libraries.
...
## 💡 Integration Strategy for SqlMermaidErdTools (.NET 10 / C#)
...
- **Implementation**:
  ```xml
  <PackageReference Include="SqlMermaidErdTools" Version="1.0.0" />
...
<Project Sdk="Microsoft.NET.Sdk">
  <PropertyGroup>
    ...
    <PackageId>SqlMermaidErdTools</PackageId>
  </PropertyGroup>
...
```
SqlMermaidErdTools.1.0.0.nupkg
├── lib/
│   └── net10.0/
...
```
┌─────────────────────────────────────────┐
│   SqlMermaidErdTools NuGet Package (C#)   │
├─────────────────────────────────────────┤
│                                         │
│  ┌──────────────┐    ┌──────────────┐  │
