...
╔══════════════════════════════════════════════════════════════╗
║                                                              ║
║           SqlMermaidErdTools - SQL to Mermaid ERD               ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝
");
...
USAGE:
    SqlMermaidErdTools.Samples <input-file> [options]
...
EXAMPLES:
    Convert SQL to .mmd file:
        SqlMermaidErdTools.Samples database.sql

    Convert SQL to .md file with Mermaid diagram:
        SqlMermaidErdTools.Samples database.sql --markdown
