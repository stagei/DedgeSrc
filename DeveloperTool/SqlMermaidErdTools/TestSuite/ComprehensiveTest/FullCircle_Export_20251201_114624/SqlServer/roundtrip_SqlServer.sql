...
CREATE TABLE AdverseEvents (
    ...
    ReportedToRegionalEthicsCommittee BIT NOT NULL,
    RegionalEthicsCommitteeReportDate TIMESTAMP NOT NULL,
    ReportedToSLV BIT NOT NULL,
    SLVReportDate TIMESTAMP NOT NULL,
    ReportedToSponsor BIT NOT NULL,
...
CREATE TABLE Inspections (
    ...
    FollowUpCompleted BIT NOT NULL,
    ReportReceived BIT NOT NULL,
    ReportDate TIMESTAMP NOT NULL,
