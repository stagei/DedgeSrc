...
$about_label = op_get_option( 'op_about_label', 'About Us' );
$about_title = op_get_option( 'op_about_title', 'Your health in safe hands' );
$about_lead  = op_get_option( 'op_about_lead', '' );
$about_text1 = op_get_option( 'op_about_text1', '' );
$about_text2 = op_get_option( 'op_about_text2', '' );

// Stats: only render if both number AND label are non-empty
$about_stats = array();
for ( $i = 1; $i <= 3; $i++ ) {
    $number = op_get_option( "op_about_stat{$i}_number", '' );
    $label  = op_get_option( "op_about_stat{$i}_label", '' );
    ...
    <div class="container">
        ...
        <div class="about-grid">
            <div class="about-image">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/about.png' ); ?>" alt="<?php echo esc_attr( $about_label ); ?>" class="about-image-real">
            </div>
