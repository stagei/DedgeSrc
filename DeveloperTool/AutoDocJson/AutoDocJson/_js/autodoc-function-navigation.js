...
(function() {
    ...
    function highlightMermaidNode(functionName) {
        // If GoJS is active for the flow diagram, use GoJS API
        if (window.autodocRenderer && window.autodocRenderer.isGoJSActive('flow')) {
            window.autodocRenderer.goJSFindAndHighlightNode('flow', functionName);
            return;
        }
