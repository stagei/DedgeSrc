...
3. Click **Create**
4. Fill in:
   - **Key Name**: `Sql2MermaidErdConverter`
   - **Glob Pattern**: `Sql2MermaidErdConverter*`
...
2. Repository name: `SqlMmdConverter`
3. Make it **Public**
4. Add MIT License
5. Create repository
...
git remote add origin https://github.com/YOUR_USERNAME/SqlMmdConverter.git
git branch -M main
...
Check: https://www.nuget.org/packages/Sql2MermaidErdConverter
...
- Update `<Version>` in SqlMmdConverter.csproj
...
- Ensure glob pattern includes `Sql2MermaidErdConverter*`
