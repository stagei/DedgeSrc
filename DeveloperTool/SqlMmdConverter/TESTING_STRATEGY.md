# Testing Strategy for SqlMmdConverter

## Overview

SqlMmdConverter uses a comprehensive automated testing strategy that validates bidirectional conversion between SQL DDL and Mermaid ERD diagrams. Tests use pre-generated reference files and automated comparison to ensure accuracy.
...
```sql
-- Reference schema for SqlMmdConverter testing
