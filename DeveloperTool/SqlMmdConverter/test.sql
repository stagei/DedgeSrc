...
-- Database: D:\opt\src\Misc\ClinicalStudiesSystem\MedTrailDb.accdb
-- Generated: 2025-11-30 19:08:17
-- ============================================
...
ALTER TABLE [AdverseEvents]
    ADD CONSTRAINT [FK_AdverseEvents_ClosedByTrialPersonnel]
    FOREIGN KEY ([ClosedByTrialPersonnelID])
    REFERENCES [TrialPersonnel] ([TrialPersonnelID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [AdverseEvents]
    ADD CONSTRAINT [FK_AdverseEvents_EventType]
...
ALTER TABLE [AdverseEvents]
    ADD CONSTRAINT [FK_AdverseEvents_TrialPatient]
    FOREIGN KEY ([PatientID])
    REFERENCES [TrialPatients] ([PatientID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Authorities]
    ADD CONSTRAINT [FK_Authorities_AuthorityTypes]
    FOREIGN KEY ([AuthorityType])
    REFERENCES [AuthorityTypes] ([AuthorityType])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Authorities]
    ADD CONSTRAINT [FK_Authorities_LegislationCountry]
    FOREIGN KEY ([LegislationCountryCode])
    REFERENCES [CountryCodes] ([CountryCode])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Authorities]
    ADD CONSTRAINT [FK_Authorities_Organizations]
...
ALTER TABLE [AuthorityPersonnel]
    ADD CONSTRAINT [FK_AuthorityPersonnel_Authority]
...
ALTER TABLE [AuthorityPersonnel]
    ADD CONSTRAINT [FK_AuthorityPersonnel_Person]
...
ALTER TABLE [AuthoritySteps]
    ADD CONSTRAINT [FK_AuthoritySteps_Authority]
    FOREIGN KEY ([AuthorityID])
    REFERENCES [Authorities] ([AuthorityID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [Documents]
    ADD CONSTRAINT [FK_Documents_ApprovedByHospitalPersonnel]
    FOREIGN KEY ([ApprovedByHospitalPersonnelID])
    REFERENCES [HospitalPersonnel] ([HospitalPersonnelID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Documents]
    ADD CONSTRAINT [FK_Documents_ApprovedBySponsorPersonnel]
    FOREIGN KEY ([ApprovedBySponsorPersonnelID])
    REFERENCES [SponsorPersonnel] ([SponsorPersonnelID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Documents]
    ADD CONSTRAINT [FK_Documents_DocumentType]
    FOREIGN KEY ([DocumentType])
    REFERENCES [DocumentTypes] ([DocumentType])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Documents]
    ADD CONSTRAINT [FK_Documents_Trial]
    FOREIGN KEY ([TrialID])
    REFERENCES [Trials] ([TrialID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [Hospitals]
    ADD CONSTRAINT [FK_Hospital_CountryCodes]
    FOREIGN KEY ([LegislativeCountryCode])
    REFERENCES [CountryCodes] ([CountryCode])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Hospitals]
    ADD CONSTRAINT [FK_Hospital_Organizations]
    FOREIGN KEY ([OrganizationID])
    REFERENCES [Organizations] ([OrganizationID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [HospitalPersonnel]
    ADD CONSTRAINT [FK_HospitalPersonnel_Hospitals]
...
ALTER TABLE [HospitalPersonnel]
    ADD CONSTRAINT [FK_HospitalPersonnel_Person]
    FOREIGN KEY ([PersonID])
    REFERENCES [Persons] ([PersonID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [InspectionLogs]
    ADD CONSTRAINT [FK_InspectionLogs_Inspection]
...
ALTER TABLE [Inspections]
    ADD CONSTRAINT [FK_Inspections_InspectionTypes]
    FOREIGN KEY ([InspectionType])
    REFERENCES [InspectionTypes] ([InspectionType])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Inspections]
    ADD CONSTRAINT [FK_Inspections_SponsorTrialRole]
    FOREIGN KEY ([SponsorTrialRoleID])
    REFERENCES [TrialRoles] ([TrialRoleID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Inspections]
    ADD CONSTRAINT [FK_Inspections_Trial]
    FOREIGN KEY ([TrialID])
    REFERENCES [Trials] ([TrialID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [Inspections]
    ADD CONSTRAINT [FK_Inspections_TrialPersonnel]
    FOREIGN KEY ([TrialPersonnelID])
    REFERENCES [TrialPersonnel] ([TrialPersonnelID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Milestones]
    ADD CONSTRAINT [FK_Milestones_Authority]
    FOREIGN KEY ([InvolvesAuthorityID])
    REFERENCES [Authorities] ([AuthorityID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [Milestones]
    ...
    FOREIGN KEY ([MilestoneType])
    REFERENCES [MilestoneTypes] ([MilestoneType])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Milestones]
    ADD CONSTRAINT [FK_Milestones_ResponsibleTrialRole]
    FOREIGN KEY ([ResponsibleTrialRoleID])
    REFERENCES [TrialRoles] ([TrialRoleID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Milestones]
    ADD CONSTRAINT [FK_Milestones_TransitionPhaseCodes]
    FOREIGN KEY ([TransitionPhaseCode])
    REFERENCES [PhaseCodes] ([PhaseCode])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Milestones]
    ADD CONSTRAINT [FK_Milestones_Trial]
    FOREIGN KEY ([TrialID])
    REFERENCES [Trials] ([TrialID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [MilestoneSteps]
    ADD CONSTRAINT [FK_MilestoneSteps_ActionCodes]
    FOREIGN KEY ([ActionCode])
    REFERENCES [ActionCodes] ([ActionCode])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [MilestoneSteps]
    ADD CONSTRAINT [FK_MilestoneSteps_AuthorityStep]
    FOREIGN KEY ([AuthorityStepID])
    REFERENCES [AuthoritySteps] ([AuthorityStepID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [MilestoneSteps]
    ADD CONSTRAINT [FK_MilestoneSteps_Milestone]
...
ALTER TABLE [MilestoneSteps]
    ADD CONSTRAINT [FK_MilestoneSteps_TrialRole]
    FOREIGN KEY ([TrialRoleID])
    REFERENCES [TrialRoles] ([TrialRoleID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Organizations]
    ADD CONSTRAINT [FK_Organization_CountryCodes]
...
ALTER TABLE [OrganizationDepartments]
    ADD CONSTRAINT [FK_OrganizationDepartment_Organizations]
    FOREIGN KEY ([OrganizationID])
    REFERENCES [Organizations] ([OrganizationID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [PatientSchedules]
    ADD CONSTRAINT [FK_PatientSchedules_Protocol]
    FOREIGN KEY ([AffectedByProtocolID])
    REFERENCES [Protocols] ([ProtocolID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [PatientSchedules]
    ADD CONSTRAINT [FK_PatientSchedules_Trial]
    FOREIGN KEY ([TrialID])
    REFERENCES [Trials] ([TrialID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [Persons]
    ADD CONSTRAINT [FK_Persons_CountryCodes]
    FOREIGN KEY ([CountryCode])
    REFERENCES [CountryCodes] ([CountryCode])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [Protocols]
    ADD CONSTRAINT [FK_Protocols_Document]
...
ALTER TABLE [Protocols]
    ADD CONSTRAINT [FK_Protocols_Trial]
    FOREIGN KEY ([TrialID])
    REFERENCES [Trials] ([TrialID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [QualityManagementReviews]
    ADD CONSTRAINT [FK_QualityManagementLogs_ReportDocument]
...
ALTER TABLE [QualityManagementReviews]
    ADD CONSTRAINT [FK_QualityManagementLogs_ResolvedByTrialPersonnel]
    FOREIGN KEY ([ResolvedByTrialPersonnelID])
    REFERENCES [TrialPersonnel] ([TrialPersonnelID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [QualityManagementReviews]
    ADD CONSTRAINT [FK_QualityManagementLogs_Trial]
    FOREIGN KEY ([TrialID])
    REFERENCES [Trials] ([TrialID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [QualityManagementReviews]
    ADD CONSTRAINT [FK_QualityManagementLogs_TrialPersonnel]
    FOREIGN KEY ([PerformedByTrialPersonnelID])
    REFERENCES [TrialPersonnel] ([TrialPersonnelID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [SponsorPersonnel]
    ADD CONSTRAINT [FK_SponsorPersonnel_Person]
    FOREIGN KEY ([PersonID])
    REFERENCES [Persons] ([PersonID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [SponsorPersonnel]
    ADD CONSTRAINT [FK_SponsorPersonnel_Sponsor]
...
ALTER TABLE [Sponsors]
    ADD CONSTRAINT [FK_Sponsors_Organizations]
    FOREIGN KEY ([OrganizationID])
    REFERENCES [Organizations] ([OrganizationID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [TrialDeviations]
    ADD CONSTRAINT [FK_TrialDeviations_DeviationTypes]
    FOREIGN KEY ([DeviationType])
    REFERENCES [DeviationTypes] ([DeviationType])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [TrialDeviations]
    ADD CONSTRAINT [FK_TrialDeviations_ResponsibleTrialRole]
    FOREIGN KEY ([ResponsibleTrialRoleID])
    REFERENCES [TrialRoles] ([TrialRoleID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [TrialDeviations]
    ADD CONSTRAINT [FK_TrialDeviations_Trial]
    FOREIGN KEY ([TrialID])
    REFERENCES [Trials] ([TrialID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [TrialPatients]
    ADD CONSTRAINT [FK_TrialPatients_Trial]
    FOREIGN KEY ([TrialID])
    REFERENCES [Trials] ([TrialID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [TrialPersonnel]
    ADD CONSTRAINT [FK_TrialPersonnel_AuthorityPersonnel]
    FOREIGN KEY ([AuthorityPersonnelID])
    REFERENCES [AuthorityPersonnel] ([AuthorityPersonnelID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [TrialPersonnel]
    ADD CONSTRAINT [FK_TrialPersonnel_HospitalPersonnel]
    FOREIGN KEY ([HospitalPersonnelID])
    REFERENCES [HospitalPersonnel] ([HospitalPersonnelID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [TrialPersonnel]
    ADD CONSTRAINT [FK_TrialPersonnel_SponsorPersonnel]
    FOREIGN KEY ([SponsorPersonnelID])
    REFERENCES [SponsorPersonnel] ([SponsorPersonnelID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [TrialPersonnel]
    ADD CONSTRAINT [FK_TrialPersonnel_Trial]
    FOREIGN KEY ([TrialID])
    REFERENCES [Trials] ([TrialID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [TrialPersonnel]
    ADD CONSTRAINT [FK_TrialPersonnel_TrialPersonnelType]
    FOREIGN KEY ([TrialPersonnelType])
    REFERENCES [TrialPersonnelTypes] ([TrialPersonnelType])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [TrialRoles]
    ADD CONSTRAINT [FK_TrialRoles_RoleType]
    FOREIGN KEY ([RoleType])
    REFERENCES [RoleTypes] ([RoleType])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [TrialRoles]
    ADD CONSTRAINT [FK_TrialRoles_Trial]
    FOREIGN KEY ([TrialID])
    REFERENCES [Trials] ([TrialID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [TrialRoles]
    ADD CONSTRAINT [FK_TrialRoles_TrialPersonnel]
    FOREIGN KEY ([TrialPersonnelID])
    REFERENCES [TrialPersonnel] ([TrialPersonnelID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [Trials]
    ADD CONSTRAINT [FK_Trials_CurrentPhaseCodes]
    FOREIGN KEY ([CurrentPhaseCode])
    REFERENCES [PhaseCodes] ([PhaseCode])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Trials]
    ADD CONSTRAINT [FK_Trials_CurrentProtocol]
    FOREIGN KEY ([CurrentProtocolID])
    REFERENCES [Protocols] ([ProtocolID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE [Trials]
    ADD CONSTRAINT [FK_Trials_Hospitals]
    FOREIGN KEY ([HospitalID])
    REFERENCES [Hospitals] ([HospitalID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [Trials]
    ADD CONSTRAINT [FK_Trials_Sponsor]
    FOREIGN KEY ([SponsorID])
    REFERENCES [Sponsors] ([SponsorID])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE [Trials]
    ADD CONSTRAINT [FK_Trials_TrialTypes]
    FOREIGN KEY ([TrialType])
    REFERENCES [TrialTypes] ([TrialType])
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
