...
namespace GenericLogHandler.Data.Migrations
{
    ...
    [Migration("20260218194439_AddIngestQueue")]
    partial class AddIngestQueue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GenericLogHandler.Core.Models.Configuration.ImportSourceEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("IsAppendOnly")
                        .HasColumnType("boolean")
                        .HasColumnName("is_append_only");
                    ...
                    b.Property<DateTime?>("LastImportAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_import_at");

                    b.Property<int>("LastImportCount")
                        .HasColumnType("integer")
                        .HasColumnName("last_import_count");

                    b.Property<int>("MaxFileAgeDays")
                        .HasColumnType("integer")
                        .HasColumnName("max_file_age_days");
                    ...
                    b.Property<bool>("ProcessExistingFiles")
                        .HasColumnType("boolean")
                        .HasColumnName("process_existing");
                    ...
                    b.Property<bool>("WatchDirectory")
                        .HasColumnType("boolean")
                        .HasColumnName("watch_directory");

                    b.HasKey("Id");

                    b.ToTable("import_sources");
                });
            ...
            modelBuilder.Entity("GenericLogHandler.Core.Models.IngestQueueEntry", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ingest_queue", (string)null);
                });

            modelBuilder.Entity("GenericLogHandler.Core.Models.JobExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("EndLogEntryId")
                        .HasColumnType("uuid")
                        .HasColumnName("end_log_entry_id");
                    ...
                    b.Property<Guid?>("StartLogEntryId")
                        .HasColumnType("uuid")
                        .HasColumnName("start_log_entry_id");
